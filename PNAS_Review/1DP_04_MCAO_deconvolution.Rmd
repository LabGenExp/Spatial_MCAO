...
```{r libraries}
library(Seurat); library(tidyverse); library(ggplot2); library(tibble); library(openxlsx); library(RColorBrewer); library(magrittr); library(stringr); library(gridExtra); library(Matrix); library(patchwork)
