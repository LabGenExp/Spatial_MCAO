...
png(filename = file.path(ws, "ChordDiagram_CCI_counts_ctrl_cortex_and_lesion_periphery.png"), res = 1000, units = "mm", width = 430, height = 130)
...
plot.list[["GO_downstream_apoe_trem"]] <- plot_df %>% 
  ...
  geom_text(
    aes(label = Description,
        x = hjust),
    hjust = ifelse(plot_df$Pvalue > 20, 1.2, 0),
...
spatial.seurat %>% SpatialPlot(
  features = c("GO_Proteasome complex1",
               "GO_Neuron apoptotic process2",
               "GO_Positive regulation of erk1 and erk2 cascade3", 
               "GO_Gliogenesis4",
               "GO_Glucose metabolic process5",
               "GO_Chemotaxis6", 
               "GO_Positive regulation of cytokine production7", 
               "GO_Tissue remodeling8"), 
  images = c("Ctrl", sections),
  image.alpha = 0.2, 
  stroke = 0, 
  crop = T, 
...
plot.list[["Spatial_GO"]] <- spatial.seurat %>% SpatialPlot(
  features = c("GO_Positive regulation of cytokine production7", "GO_Tissue remodeling8"), 
  images = sections,
  image.alpha = 0.2, 
  stroke = 0, 
  crop = T, 
...
plot.list[["Barplot_VolumeIba1"]] <- 
  ...
  geom_bar(data = volume_iba_condition_summary, stat = "identity", width = 0.6, colour = "black", alpha = 0.75, fill = "#79A69B", size = 0.5) +
...
plot.list[["Bulk_barplot_deconvo"]] <- cibersort_summary %>% 
  ...
  annotate("text", x = 6, y = 95.25, label = expression(italic("P = 0.4437")), color = "#02818A", size = 2.45, hjust = 1) + 
  annotate("text", x = 6, y = 84.65, label = expression(italic("P = 0.0009")), color = "#A50F15", size = 2.45, hjust = 1) + 
  annotate("text", x = 6, y = 59.5, label = expression(italic("P = 0.0004")), color = "#307faf", size = 2.45, hjust = 1) + 
  annotate("text", x = 6, y = 37.85, label = expression(italic("P = 0.6699")), color = "#8C96C6", size = 2.45, hjust = 1)
