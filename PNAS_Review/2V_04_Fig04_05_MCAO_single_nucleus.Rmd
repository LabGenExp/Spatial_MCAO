...
seurat.plots[["Barplot_Immuno_Astro"]] <- 
  ...
  annotate(geom = "text", x = 1, y = 40, label = paste0("P = ", stat_test$p.value %>% round(3)), vjust = -0.5, hjust = 0.5, size = 2.45) +
  ylim(-1, 60) +
  xlab(NULL) + 
...
seurat.plots[["Barplot_Immuno_Microglia"]] <- 
  ...
  geom_errorbar(
    ...
    aes(ymin = mean_colocalization - sd_colocalization, 
        ymax = mean_colocalization + sd_colocalization), width = 0.1, color = "black", size = 0.5) +
  geom_jitter(position = position_jitter(0.2), color = 'black', size= 1.5, shape = 1, stroke = 0.5) + 
  annotate(geom = "text", x = 1, y = 20, label = paste0("P = ", stat_test$p.value %>% round(3)), vjust = -0.5, hjust = 0.5, size = 2.45) +
  ylim(0, 35) +
  xlab(NULL) + 
...
seurat.plots[["Barplot_Immuno_OL_Serpina"]] <- 
  ...
  geom_errorbar(
    ...
    aes(ymin = mean_colocalization, 
        ymax = mean_colocalization + sd_colocalization), width = 0.1, color = "black", size = 0.5) +
  geom_jitter(position = position_jitter(0.2), color = 'black', size= 1.5, shape = 1, stroke = 0.5) + 
  annotate(geom = "text", x = 1, y = 1, label = paste0("P = ", stat_test$p.value %>% round(3)), vjust = -0.5, hjust = 0.5, size = 2.45) +
  ylim(-0.1, 1.5) +
  xlab(NULL) + 
...
seurat.plots[["Barplot_Immuno_OL_B2m"]] <- 
  ...
  geom_errorbar(
    ...
    aes(ymin = mean_colocalization, 
        ymax = mean_colocalization + sd_colocalization), width = 0.1, color = "black", size = 0.5) +
  geom_jitter(position = position_jitter(0.2), color = 'black', size= 1.5, shape = 1, stroke = 0.5) + 
  annotate(geom = "text", x = 1, y = 3, label = paste0("P = ", stat_test$p.value %>% round(3)), vjust = -0.5, hjust = 0.5, size = 2.45) +
  ylim(-0.1, 11) +
  xlab(NULL) + 
...
seurat.plots[["Barplot_Immuno_OL_Tnfrsf1a"]] <- 
  ...
  geom_errorbar(
    ...
    aes(ymin = mean_colocalization, 
        ymax = mean_colocalization + sd_colocalization), width = 0.1, color = "black", size = 0.5) +
  geom_jitter(position = position_jitter(0.2), color = 'black', size= 1.5, shape = 1, stroke = 0.5) + 
  annotate(geom = "text", x = 1, y = 50, label = paste0("P = ", stat_test$p.value %>% round(3)), vjust = -0.5, hjust = 0.5, size = 2.45) +
  ylim(-1, 90) +
  xlab(NULL) + 
...
### log-normalized-centered analysis
