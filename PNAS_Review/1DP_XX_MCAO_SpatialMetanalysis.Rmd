...
Add Simplify the brain region annotation
```{r simplify brain region annotation}
spatial.seurat@meta.data %<>% 
  mutate(BrainArea = factor(case_when(
    ...
    BrainRegionShort == "ISD3c" ~ "Lesion", 
    BrainRegionShort == "ISD3p" ~ "Lesion", 
    BrainRegionShort == "PIR" ~ "Telencephalon", 
    BrainRegionShort == "TH" ~ "Diencephalon", 
    BrainRegionShort == "V" ~ "Telencephalon"
  ), levels = c("Diencephalon", "Telencephalon", "Cortex", "Lesion")))
```
